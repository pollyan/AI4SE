...
def update_artifact(
    key: str, markdown_body: str, metadata: Optional[dict] = None
) -> str:
    """
    更新工作流产出物。
...
def ask_confirmation(message: str) -> str:
    ...
    # The frontend intercepts this tool call, renders a UI,
    # and sends back the result.
    # The result sent back by frontend should be a string
    # ("Confirmed" or "Denied" or JSON).
