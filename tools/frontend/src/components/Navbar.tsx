            ...
            <div className="max-w-[1200px] mx-auto px-10">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        ...
                        <a
                            href="/new-agents/"
                            className="text-gray-500 hover:text-gray-800 text-sm font-normal transition-colors py-2"
                        >
                            AI智能体
                        </a>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden py-4 border-t border-gray-200">
                        ...
                        <a href="/new-agents/" className="block py-2 text-sm text-gray-600 hover:text-gray-800">AI智能体</a>
