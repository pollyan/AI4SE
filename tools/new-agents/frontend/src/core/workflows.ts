...
import { STORY_WRITING_PROMPT, STORY_WRITING_TEMPLATE } from './prompts/story_breakdown/story_writing';
import { SPRINT_SLICING_PROMPT, SPRINT_SLICING_TEMPLATE } from './prompts/story_breakdown/sprint_slicing';
...
const STAGE_CONTENT_BY_TEMPLATE_ID: Record<string, StageContent> = {
        ...
        'story_breakdown.story_writing': {
            description: STORY_WRITING_PROMPT,
            template: STORY_WRITING_TEMPLATE,
        },
        'story_breakdown.sprint_slicing': {
            description: SPRINT_SLICING_PROMPT,
            template: SPRINT_SLICING_TEMPLATE,
        },
};
