...
- 每个问题必须包含：问题描述、优先级（P0/P1/P2）、所属需求章节、影响范围、证据/依据、建议、责任方/确认人。
...
| ID | 问题描述 | 优先级 | 所属需求章节 | 影响范围 | 证据/依据 | 建议 | 责任方/确认人 |
|----|---------|--------|------------|----------|-----------|------|----------------|
| Q-001 | [具体描述] | P0/P1/P2 | [章节名] | [影响的用户/流程/系统/测试范围] | [需求原文、缺失信息或矛盾点] | [改进建议] | [PM/研发/测试/业务方] |

## 2. [评审维度名称，如：功能完整性问题]

| ID | 问题描述 | 优先级 | 所属需求章节 | 影响范围 | 证据/依据 | 建议 | 责任方/确认人 |
|----|---------|--------|------------|----------|-----------|------|----------------|
| Q-0xx | [具体描述] | P0/P1/P2 | [章节名] | [影响的用户/流程/系统/测试范围] | [需求原文、缺失信息或矛盾点] | [改进建议] | [PM/研发/测试/业务方] |
