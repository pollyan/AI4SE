 ...
 * 该 Prompt 包含角色设定、变更标识规则、阶段推进协议和输出格式约束。
 *
 * @param workflow  当前工作流 ID
 * @param stageIndex 当前阶段索引
 * @param currentArtifact 当前产出物内容（用于注入上下文）
 */
export const getSystemPrompt = (workflow: WorkflowType, stageIndex: number, currentArtifact: string) => {
