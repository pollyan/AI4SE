...
## ICE 评估表
| 编号 | 创意名称 | 影响力 (1-5) | 信心 (1-5) | 实现难度 (1-5) | ICE得分 | 排名 | 结论 | 淘汰理由 | 推荐方案 | 下一步验证 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| C-01 | [创意名称] | [分数+一句话理由] | [分数+一句话理由] | [分数+一句话理由] | [乘积] | [1/2/3...] | [入选/淘汰/合并至C-xx] | [如果淘汰，说明原因；入选填 -] | [保留/合并/降级/暂停] | [最小验证实验或用户访谈问题] |
