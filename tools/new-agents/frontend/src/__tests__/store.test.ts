...
describe('Zustand Store', () => {
    ...
    it('should ignore workflow handoffs that do not match the configured target agent or stage', () => {
        ...
        useStore.getState().applyWorkflowHandoff({
            ...
            sourceArtifactSummary: 'AI 测试资产管理平台需求蓝图；AI 测试资产管理平台。',
            unresolvedItems: [],
            targetInputSummary: '将 VALUE_DISCOVERY/BLUEPRINT v1 作为 TEST_DESIGN/CLARIFY 的启动输入。',
            targetWorkflowId: 'TEST_DESIGN',
            targetStageId: 'CLARIFY',
            targetAgentId: 'alex',
            prompt: '不应应用',
        ...
        useStore.getState().applyWorkflowHandoff({
            ...
            sourceArtifactSummary: 'AI 测试资产管理平台需求蓝图；AI 测试资产管理平台。',
            unresolvedItems: [],
            targetInputSummary: '将 VALUE_DISCOVERY/BLUEPRINT v1 作为 TEST_DESIGN/UNKNOWN_STAGE 的启动输入。',
            targetWorkflowId: 'TEST_DESIGN',
