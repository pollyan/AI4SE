...
| **LLM 客户端** | OpenAI Python SDK + PydanticAI | 2.x / 1.104.0 |
...
| **new-agents-backend** | `tools/new-agents/backend/` | 后端 API | PydanticAI 结构化 Agent Runtime 与 Mermaid 工具服务 |
...
- **LLM 集成**: New Agents 主链路由后端 PydanticAI Agent Runtime 统一调用 LLM，前端只消费 typed SSE/JSON 结果
