...
- `2026-06-23-new-agents-enhancement-diagnostic.md`：New Agents 功能盘点、差距分析和增强路线活动候选；E13 Alex 用户故事拆解 workflow 已在 2026-06-24 本分支消化，E14、Artifact 质量诊断、Lisa 测试资产质量闭环等仍是后续候选。
