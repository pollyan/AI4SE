...
本目录记录重构类扫描、方案和实施待办。已完成的 todo 归档到 `docs/todos/archive/`；当前仍有活跃重构/增强候选，见“当前入口”。
...
- `2026-06-23-new-agents-enhancement-diagnostic.md`：New Agents 功能盘点、差距分析和增强路线活动候选。2026-06-23 已消化 E13 `STORY_BREAKDOWN/BACKLOG`，E14 `PRD_REVIEW` 仍为活跃 P0 候选。
