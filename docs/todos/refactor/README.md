...
- `2026-06-23-deepseek-v4-structured-artifact-data.md`：DeepSeek V4 Flash 兼容的后端结构化产物数据改造活动候选；2026-06-23 已补本地 deterministic evidence gate，真实 DeepSeek smoke 仍需显式凭证/网络/额度。
