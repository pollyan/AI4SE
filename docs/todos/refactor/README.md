...
2026-06-23 已复核：DeepSeek V4 结构化产物数据改造已收口并归档；除上述活动候选外，其他重构类事项均已归档或转为 `docs/plans/tech-debt.md` 中的历史完成记录。不要从 `archive/` 中的过程性“待办/剩余”直接恢复实施。
...
- `../archive/2026-06-23-deepseek-v4-structured-artifact-data.md`：DeepSeek V4 Flash 兼容的后端结构化产物数据改造与 readiness 收口门禁。
